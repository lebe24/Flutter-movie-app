...
class _DetailPageState extends State<DetailPage> {
  late Future<String?> videoId ; 
  final VideoPlayer videoPlayer = YouTubeVideoPlayerImpl();


  @override
  void initState() {
    super.initState();
    videoId = getYouTubeTrailerId(widget.data.results[widget.index].id!); 
    print(videoId);
            ...
            child: Column(
              ...
              children: [
                      ...
                      FutureBuilder<String?>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          return GestureDetector(
                            onTap: snapshot.hasData ? () => videoPlayer.showVideoPlayerDialog(
                              context: context,
                              videoId: snapshot.data!
                            ) : null,
                            // onTap: (){
                            //   videoId =  getYouTubeTrailerId(912649);
                            //   print(videoId);
                            //   videoPlayer.showVideoPlayerDialog(
                            //   context: context,
                ...
                ReviewsWidget(
                    ...
                    id: widget.data.results[widget.index].id!),
                // VideoPlayer(
                //   videoId: widget.data.results[widget.index].id!.toString(),
